      ...
      <div className="card-body">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-3">
            ...
            <textarea name="hazirlanisi" id="hazirlanisi" cols="20" rows="5" placeholder='Tarifi giriniz...' className='form-control' onChange={(e) => setHazirlanisi(e.target.value)}></textarea>
          </div>
          <div className="mb-3">
